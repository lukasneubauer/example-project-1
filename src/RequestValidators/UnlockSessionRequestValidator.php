...
class UnlockSessionRequestValidator
{
    ...
    public function validateRequest(
        ...
        try {
            ...
            $this->requestValidator->checkIfPropertyOldApiClientIdIsMissingInRequestBody($data);
            $this->requestValidator->checkIfPropertyOldApiClientIdIsOfCorrectDataTypeInRequestBody($data);
            $this->requestValidator->checkIfPropertyOldApiClientIdIsNonEmptyStringInRequestBody($data);
            $this->requestValidator->checkIfUserIsTryingToUseAnotherEmailAddress($headers, $data);
            $this->requestValidator->checkIfOldApiClientIdIsDifferentThanTheOneInCurrentSession($headers, $data);
