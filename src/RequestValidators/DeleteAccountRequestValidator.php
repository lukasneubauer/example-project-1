...
class DeleteAccountRequestValidator
{
    ...
    public function validateRequest(
        ...
        try {
            ...
            $this->requestValidator->checkIfAnyDataForPropertyUserIdWereFound($data);
            $this->requestValidator->checkIfCannotDeleteTeacherWithOngoingCourses($data);
            $this->requestValidator->checkIfCannotDeleteStudentWhichIsSubscribedToOngoingCourses($data);
