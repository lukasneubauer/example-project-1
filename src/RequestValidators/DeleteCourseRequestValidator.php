...
class DeleteCourseRequestValidator
{
    ...
    public function validateRequest(
        ...
        try {
            ...
            $this->requestValidator->checkIfAnyDataForPropertyCourseIdWereFound($data);
            $this->requestValidator->checkIfTheUserIsTeacherToAcceptThisRequest($headers);
            $this->requestValidator->checkIfTheUserIsTeacherToDeleteTheCourse($headers, $data);
            $this->requestValidator->checkIfCannotDeleteOngoingOrEndedCourse($data);
