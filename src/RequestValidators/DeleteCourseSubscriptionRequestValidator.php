...
class DeleteCourseSubscriptionRequestValidator
{
    ...
    public function validateRequest(
        ...
        try {
            ...
            $this->requestValidator->checkIfCannotUnsubscribeFromOngoingOrEndedCourse($data);
            $this->requestValidator->checkIfCannotUnsubscribeFromCourseToWhichYouAreNotSubscribedTo($headers, $data);
