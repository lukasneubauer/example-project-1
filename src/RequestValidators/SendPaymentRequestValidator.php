...
class SendPaymentRequestValidator
{
    ...
    public function validateRequest(
        ...
        try {
            ...
            $this->requestValidator->checkIfCannotSendPaymentForTheCourseToWhichYouAreNotSubscribedTo($headers, $data);
            $this->requestValidator->checkIfCannotSendPaymentForTheSameCourseAgain($headers, $data);
            $this->requestValidator->checkIfCannotSendPaymentForTheOngoingOrEndedCourse($data);
