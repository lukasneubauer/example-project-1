...
final class SubjectsControllerFunctionalTest extends WebTestCase
{
    /** @var string */
    public const METHOD = 'GET';

    /** @var string */
    public const ENDPOINT = '/-/subjects';
    ...
    public function testOk(): void
    {
        ...
        try {
            ...
            $this->assertSame('Anglický jazyk', $data[0]['name']);
            ...
            $this->assertSame('Anglický jazyk', $subjects[0]->getName());
        } catch (RuntimeException $e) {
            throw $e;
        } finally {
            Database::resetDatabase($dic);
