 ...
 */
final class Version20220609120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `courses` CHANGE `id` `id` char(36) COLLATE \'utf8mb4_unicode_ci\' NOT NULL FIRST, CHANGE `subject_id` `subject_id` char(36) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `id`, CHANGE `teacher_id` `teacher_id` char(36) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `subject_id`, CHANGE `name` `name` varchar(255) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `teacher_id`, COLLATE \'utf8mb4_unicode_ci\'');
        $this->addSql('ALTER TABLE `course_subscriptions` CHANGE `course_id` `course_id` char(36) COLLATE \'utf8mb4_unicode_ci\' NOT NULL FIRST, CHANGE `student_id` `student_id` char(36) COLLATE \'utf8mb4_unicode_ci\' NOT NULL AFTER `course_id`, COLLATE \'utf8mb4_unicode_ci\'');
        $this->addSql('ALTER TABLE `lessons` CHANGE `id` `id` char(36) COLLATE \'utf8mb4_unicode_ci\' NOT NULL FIRST, CHANGE `course_id` `course_id` char(36) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `id`, CHANGE `name` `name` varchar(255) COLLATE \'utf8mb4_unicode_ci\' NOT NULL AFTER `to`, COLLATE \'utf8mb4_unicode_ci\'');
        $this->addSql('ALTER TABLE `sessions` CHANGE `id` `id` char(36) COLLATE \'utf8mb4_unicode_ci\' NOT NULL FIRST, CHANGE `user_id` `user_id` char(36) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `id`, CHANGE `api_client_id` `api_client_id` char(40) COLLATE \'utf8mb4_unicode_ci\' NOT NULL AFTER `user_id`, CHANGE `old_api_token` `old_api_token` char(80) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `api_client_id`, CHANGE `current_api_token` `current_api_token` char(80) COLLATE \'utf8mb4_unicode_ci\' NOT NULL AFTER `old_api_token`, COLLATE \'utf8mb4_unicode_ci\'');
        $this->addSql('ALTER TABLE `subjects` CHANGE `id` `id` char(36) COLLATE \'utf8mb4_unicode_ci\' NOT NULL FIRST, CHANGE `created_by_id` `created_by_id` char(36) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `id`, CHANGE `name` `name` varchar(255) COLLATE \'utf8mb4_unicode_ci\' NOT NULL AFTER `created_by_id`, COLLATE \'utf8mb4_unicode_ci\'');
        $this->addSql('ALTER TABLE `users` CHANGE `id` `id` char(36) COLLATE \'utf8mb4_unicode_ci\' NOT NULL FIRST, CHANGE `first_name` `first_name` varchar(255) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `id`, CHANGE `last_name` `last_name` varchar(255) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `first_name`, CHANGE `email` `email` varchar(255) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `last_name`, CHANGE `password_hash` `password_hash` varchar(255) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `email`, CHANGE `password_algorithm` `password_algorithm` varchar(255) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `password_hash`, CHANGE `timezone` `timezone` varchar(255) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `is_student`, CHANGE `token` `token` char(20) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `timezone`, CHANGE `security_code` `security_code` char(9) COLLATE \'utf8mb4_unicode_ci\' NULL AFTER `token_created_at`, COLLATE \'utf8mb4_unicode_ci\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `sessions` CHANGE `id` `id` char(36) COLLATE \'ascii_general_ci\' NOT NULL FIRST, CHANGE `user_id` `user_id` char(36) COLLATE \'ascii_general_ci\' NULL AFTER `id`, CHANGE `api_client_id` `api_client_id` char(40) COLLATE \'ascii_general_ci\' NOT NULL AFTER `user_id`, CHANGE `old_api_token` `old_api_token` char(80) COLLATE \'ascii_general_ci\' NULL AFTER `api_client_id`, CHANGE `current_api_token` `current_api_token` char(80) COLLATE \'ascii_general_ci\' NOT NULL AFTER `old_api_token`, COLLATE \'ascii_general_ci\'');
